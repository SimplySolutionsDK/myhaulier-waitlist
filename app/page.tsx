        ...
        >
          ...
          >
            ...
            <span
              style={{
                background:
                  "linear-gradient(135deg, #60a5fa 0%, #93c5fd 50%, #3b82f6 100%)",
          ...
          >
            A new platform connecting freight forwarders to the workforce they
            need. Simple. Efficient. Built for the industry.
          </p>
        </div>
        ...
        >
          {formState === "success" ? (
            ...
            <div style={{ textAlign: "center", padding: "16px 0" }}>
              ...
              >
                {message || "We'll be in touch when we're ready."}
              </p>
            </div>
          ) : (
            /* Form state */
